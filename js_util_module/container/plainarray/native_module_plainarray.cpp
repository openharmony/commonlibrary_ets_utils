...
static napi_module_with_js plainArrayModule = {
    .nm_version = 1,
    .nm_flags = 0,
    .nm_filename = nullptr,
    ...
    .nm_priv = ((void*)0),
    .nm_get_abc_code = NAPI_util_PlainArray_GetABCCode,
    .nm_get_js_code = NAPI_util_PlainArray_GetJSCode,
};

extern "C" __attribute__ ((constructor)) void PlainArrrayRegisterModule()
{
    napi_module_with_js_register(&plainArrayModule);
}
} // namespace  OHOS::Util
