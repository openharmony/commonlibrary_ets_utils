...
class SendableLruCache {
  ...
  public async updateCapacity(newCapacity: number): Promise<void> {
  ...
  public async get(key: Object): Promise<Object | undefined> {
    ...
    if (createValue === undefined) {
      ...
      value = await this.put(key, createValue);
      this.createCount++;
      if (value !== undefined) {
  ...
  public async put(key: Object, value: Object): Promise<Object | undefined> {
    if (typeof (key as Object) === 'undefined') {
      let error = new Error(`Parameter error. The type of ${key} must be Object`);
      throw error;
    }
  ...
  public async remove(key: Object): Promise<Object | undefined> {
    if (typeof (key as Object) === 'undefined' || key === null) {
      let error = new Error(`Parameter error. The type of ${key} must be Object`);
      throw error;
    }
  ...
  public async contains(key: Object): Promise<boolean> {
    if (typeof (key as Object) === 'undefined') {
      let error = new Error(`Parameter error. The type of ${key} must be Object`);
      throw error;
    }
  ...
  public async getCreateCount(): Promise<number> {
    return this.createCount;
  }

  public async getMissCount(): Promise<number> {
    return this.missCount;
  }

  public async getRemovalCount(): Promise<number> {
    return this.evictionCount;
  }

  public async getMatchCount(): Promise<number> {
    return this.hitCount;
  }

  public async getPutCount(): Promise<number> {
  ...
  public async values(): Promise<Object[]> {
  ...
  public async keys(): Promise<Object[]> {
    let arr: Array<Object> = [];
  ...
  public async entries(): Promise<IterableIterator<[Object, Object]>> {
    return this.cache.entries();
  }

  public async [Symbol.iterator](): Promise<IterableIterator<[Object, Object]>> {
    return this.cache.entries();
  }
}
