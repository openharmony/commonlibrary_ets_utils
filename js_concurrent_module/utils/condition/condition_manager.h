...
#ifndef JS_CONCURRENT_MODULE_UTILS_CONDITION_MANAGER_H
#define JS_CONCURRENT_MODULE_UTILS_CONDITION_MANAGER_H
...
private:
    ...
    static napi_value NotifyAll(napi_env env, napi_callback_info cbinfo);
