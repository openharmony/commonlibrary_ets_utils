...
- 图库详情页功能测试
  - [ ] 已通过
- 图库相册功能测试：拍几张照片，进入图库相册功能，右上角+号创建新相册，弹窗中选择所有相册，查看是否有内容列表
  - [ ] 已通过
- 备忘录图片功能测试：拍几张照片，进入备忘录新增内容，选择添加图片功能，弹窗中选择所有相册，查看是否有内容列表
  - [ ] 已通过
...
- wukong压测2小时验证（非Test代码需要）
  - [ ] 无相关crash产生
  - [ ] 不涉及，无需验证
- 线程泄露测试（修改涉及线程生命周期需要，执行命令 ps -AT|grep pid|grep OS_TaskWorker|wc -l）
  - [ ] 无线程泄露
  - [ ] 不涉及，无需验证
### 7. 需求上库自检
