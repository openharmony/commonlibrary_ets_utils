...
HWTEST_F(NativeEngineTest, testUrlModule009, testing::ext::TestSize.Level0)
{
    napi_env env = (napi_env)engine_;
    napi_value exports = nullptr;
    napi_create_object(env, &exports);
    ...
    napi_value urlClass = nullptr;
    napi_value constructorArgs[1] =  { 0 };
    std::string input = "http://username:password@www.testut.com:99/path/path?query#fagment";
    napi_create_string_utf8(env, input.c_str(), input.size(), &constructorArgs[0]);
    napi_get_named_property(env, exports, "Url", &urlClass);
    napi_value instance = nullptr;
    napi_new_instance(env, urlClass, 1, constructorArgs, &instance);

    std::string input1 = "http11:";
    napi_value newValue = nullptr;
    napi_create_string_utf8(env, input1.c_str(), input1.size(), &newValue);
    napi_set_named_property(env, instance, "protocol", newValue);
    napi_value urlProperty = nullptr;
    ...
    napi_get_named_property(env, instance, "pathname", &urlProperty);
    res = GetStringUtf8(env, urlProperty);
    ASSERT_STREQ(res.c_str(), "/pathda/fanah");
...
HWTEST_F(NativeEngineTest, testUrlModule010, testing::ext::TestSize.Level0)
{
    napi_env env = (napi_env)engine_;
    napi_value exports = nullptr;
    napi_create_object(env, &exports);
    ...
    napi_value urlClass = nullptr;
    napi_value constructorArgs[1] =  { 0 };
    std::string input = "http://username:password@www.test123.com:99/path/path?query#fagment";
    napi_create_string_utf8(env, input.c_str(), input.size(), &constructorArgs[0]);
    napi_get_named_property(env, exports, "Url", &urlClass);
    napi_value instance = nullptr;
    napi_new_instance(env, urlClass, 1, constructorArgs, &instance);

    std::string input1 = "www.example123.com";
    napi_value newValue = nullptr;
    napi_create_string_utf8(env, input1.c_str(), input1.size(), &newValue);
    napi_set_named_property(env, instance, "hostname", newValue);
    napi_value urlProperty = nullptr;
    napi_get_named_property(env, instance, "hostname", &urlProperty);
    std::string res = GetStringUtf8(env, urlProperty);
    ASSERT_STREQ(res.c_str(), "www.example123.com");
    ...
    napi_get_named_property(env, instance, "search", &urlProperty);
    res = GetStringUtf8(env, urlProperty);
    ASSERT_STREQ(res.c_str(), "?query1=banf");
    ...
    napi_get_named_property(env, instance, "username", &urlProperty);
    res = GetStringUtf8(env, urlProperty);
    ASSERT_STREQ(res.c_str(), "asfee1s");
}

HWTEST_F(NativeEngineTest, testUrlModule011, testing::ext::TestSize.Level0)
{
    napi_env env = (napi_env)engine_;
    napi_value exports = nullptr;
    napi_create_object(env, &exports);
    ...
    napi_value urlClass = nullptr;
    napi_value constructorArgs[1] =  { 0 };
    std::string input = "http://username:password@www.test776.com:155/path/path?query#fagment";
    napi_create_string_utf8(env, input.c_str(), input.size(), &constructorArgs[0]);
    napi_get_named_property(env, exports, "Url", &urlClass);
    napi_value instance = nullptr;
    napi_new_instance(env, urlClass, 1, constructorArgs, &instance);

    std::string input1 = "pass123";
    napi_value newValue = nullptr;
    napi_create_string_utf8(env, input1.c_str(), input1.size(), &newValue);
    napi_set_named_property(env, instance, "password", newValue);
    napi_value urlProperty = nullptr;
    napi_get_named_property(env, instance, "password", &urlProperty);
    std::string res = GetStringUtf8(env, urlProperty);
    ASSERT_STREQ(res.c_str(), "pass123");

    input1 = "www.test.com:117";
    newValue = nullptr;
    napi_create_string_utf8(env, input1.c_str(), input1.size(), &newValue);
    napi_set_named_property(env, instance, "host", newValue);
    urlProperty = nullptr;
    napi_get_named_property(env, instance, "host", &urlProperty);
    res = GetStringUtf8(env, urlProperty);
    ASSERT_STREQ(res.c_str(), "www.test.com:117");
    ...
    napi_get_named_property(env, instance, "hash", &urlProperty);
    res = GetStringUtf8(env, urlProperty);
    ASSERT_STREQ(res.c_str(), "#fagsafd");
}

HWTEST_F(NativeEngineTest, testUrlFullUpdate002, testing::ext::TestSize.Level0)
{
    OHOS::Url::URL url("http://test.com/newpath?q=1#old");
    std::string output;
    napi_env env = (napi_env)engine_;
    
    url.SetHostname("newhost11.org");
    DealNapiStrValue(env, url.GetHostname(env), output);
    ASSERT_STREQ(output.c_str(), "newhost11.org");
    
    url.SetPath("/new/path/resourceqq");
    DealNapiStrValue(env, url.GetPath(env), output);
    ASSERT_STREQ(output.c_str(), "/new/path/resourceqq");
    
    url.SetSearch("kk=val1");
    DealNapiStrValue(env, url.GetSearch(env), output);
    ASSERT_STREQ(output.c_str(), "?kk=val1");
    
    url.SetFragment("new-Fragment");
    DealNapiStrValue(env, url.GetFragment(env), output);
    ASSERT_STREQ(output.c_str(), "#new-Fragment");
}

HWTEST_F(NativeEngineTest, testUrlParamsAppend002, testing::ext::TestSize.Level0)
{
    OHOS::Url::URLSearchParams params = OHOS::Url::URLSearchParams();
    napi_env env = (napi_env)engine_;
    napi_value key = StrToNapiValue(env, "kk1");
    napi_value val = StrToNapiValue(env, "valrr");
    params.Append(env, key, val);
    
    napi_value query = StrToNapiValue(env, "kk1");
    std::string output;
    DealNapiStrValue(env, params.Get(env, query), output);
    ASSERT_STREQ(output.c_str(), "valrr");
}

HWTEST_F(NativeEngineTest, testUrlParamsDelete004, testing::ext::TestSize.Level0)
{
    OHOS::Url::URLSearchParams params = OHOS::Url::URLSearchParams();
    napi_env env = (napi_env)engine_;
    napi_value key = StrToNapiValue(env, "token112");
    napi_value val = StrToNapiValue(env, "abc123");
    params.Append(env, key, val);
    bool value = false;
    napi_get_value_bool(env, params.IsHas(env, key), &value);
...
HWTEST_F(NativeEngineTest, testUrlParamsGetAll003, testing::ext::TestSize.Level0)
{
    OHOS::Url::URLSearchParams params = OHOS::Url::URLSearchParams();
    napi_env env = (napi_env)engine_;
    napi_value key = StrToNapiValue(env, "strnumber");
    
    params.Append(env, key, StrToNapiValue(env, "one"));
    params.Append(env, key, StrToNapiValue(env, "two"));
    params.Append(env, key, StrToNapiValue(env, "three"));
    
    std::string output;
    DealNapiStrValue(env, params.Get(env, key), output);
    ASSERT_STREQ(output.c_str(), "one");
}

HWTEST_F(NativeEngineTest, testUrlParamsSet003, testing::ext::TestSize.Level0)
{
    OHOS::Url::URLSearchParams params = OHOS::Url::URLSearchParams();
    napi_env env = (napi_env)engine_;
    napi_value key = StrToNapiValue(env, "number");
    
    params.Append(env, key, StrToNapiValue(env, "100"));
    params.Set(env, key, StrToNapiValue(env, "2000"));
